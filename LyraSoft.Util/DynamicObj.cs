...
namespace LyraSoft.Util
{
    ...
    public delegate object DyMethodDelegate(dynamic Sender, params object[] PMs);

    public class DelegateObj
    {
        private DyMethodDelegate _delegate;

        public DyMethodDelegate CallMethod
        {
            get { return _delegate; }
        }
        private DelegateObj(DyMethodDelegate D)
        {
            _delegate = D;
        }
        /// <summary>
        ...
        /// <param name="D"></param>
        /// <returns></returns>
        public static DelegateObj Function(DyMethodDelegate D)
        {
